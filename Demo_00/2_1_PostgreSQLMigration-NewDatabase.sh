...
#docker run -it --rm --network host postgres:12-alpine psql "postgresql://postgres:$PGPASSWORD@172.17.0.2:5432/worldregions"
...
https://prezi.com/hdrwxajavkq8/flyway-presentation/
